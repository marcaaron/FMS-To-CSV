module.exports = (doubleLine) => {
  return new Promise((resolve, reject)=>{
      ...
      obj.subclass_id = line1.substr(29, 13).trim() || null;
      obj.subclass_name = line1.substr(38, 30).trim() || null;
      obj.description = line2.substr(23, 50).trim() || null;
